    ...
    creators: [
      {
        ...
        description: "Instant video uploads with smart cloud integration and compression.",
        gradient: "from-blue-500 to-purple-600"
      },
      {
        icon: Users,
        title: "Editor Collaboration",
        description: "Powerful matchmaking with professional editors tailored to your needs.",
        gradient: "from-green-500 to-teal-600"
      },
      {
        icon: Youtube,
        title: "Direct Publishing",
        description: "Advanced YouTube integration with smart scheduling and optimization.",
    ...
    editors: [
      {
        ...
        description: "Professional-grade editing tools with AI-powered suggestions.",
        gradient: "from-indigo-500 to-purple-600"
      },
      {
        icon: Layers,
        title: "Project Management",
        description: "Intuitive workflow tracking and client communication hub.",
    ...
    <div className="bg-zinc-950 text-zinc-100 min-h-screen">
      ...
      <nav className="sticky top-0 z-50 bg-zinc-900/80 backdrop-blur-md border-b border-zinc-800">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-2xl font-bold text-zinc-100">CreatorSync</span>
          </div>
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Button 
              variant="default" 
              className="bg-zinc-100 text-zinc-900 hover:bg-zinc-200" onClick={()=> navigate("/login")}
            >
              Login
            </Button>
          </div>
      ...
      <div className="container mx-auto px-4 pt-16 pb-8 text-center">
        <motion.h1 
          ...
          className="text-4xl md:text-5xl font-bold text-zinc-100 mb-6 max-w-4xl mx-auto leading-tight"
        >
          Revolutionize Your Video Production Workflow
        </motion.h1>
        ...
        >
          Streamline collaboration, editing, and publishing with our comprehensive video management platform.
        </motion.p>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              { 
                ...
                description: "End-to-end encryption and secure OAuth authentication." 
              },
              { 
                icon: Zap, 
                title: "High Performance", 
                description: "Lightning-fast uploads with advanced cloud optimization." 
              },
              { 
                icon: Globe, 
                title: "Global Collaboration", 
                description: "Connect with creators and editors across the globe." 
              }
            ].map((feature, index) => (
              <div 
                key={index} 
